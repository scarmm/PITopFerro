    ...
    return (
        <View style={intro.fundo}>
            ...
            <ImageBackground source={require('../imagens/quarto.png')} style={intro.backgroundImage}>
                ...
                <Icon.Button style={intro.botico2} name="left" size={25} color="#6f7f76" backgroundColor={"rgba(0, 0, 0, 0.0)"} onPress={() => navigation.navigate("Introducao2") } >
                </Icon.Button>
                <Icon.Button style={intro.botico} name="right" size={25} color="#6f7f76" backgroundColor={"rgba(0, 0, 0, 0.0)"} onPress={() => navigation.navigate("Login") } >
                </Icon.Button>
                </View>
