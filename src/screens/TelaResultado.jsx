    ...
    return (
        <View style={principas.container}>
            ...
            <View style={principas.titulotext1}>
                <Text style={principas.resultadopesquisa}>Resultados relacionados a sua pesquisa...</Text>
            </View>
            <View style={principas.containerboxs}>
                <View style={principas.boxs}>

                    <View style={principas.imgbox1}>
                        <Image style={principas.imgbox} source={{ uri: require("../imagens/mesa9.jpg") }}></Image>
                    </View>
